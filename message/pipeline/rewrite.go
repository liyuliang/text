...
const printerType = "github.com/liyuliang/text/message.Printer"
...
func (r *rewriter) Visit(n ast.Node) ast.Visitor {
	...
	// "github.com/liyuliang/text/message".Printer.
...
var rewriteFuncs = map[string]map[string]rewriteType{
	// TODO: Printer -> *github.com/liyuliang/text/message.Printer
	"fmt": {
