...
import (
	...
	fmtparser "github.com/liyuliang/text/internal/format"
...
func (x *extracter) seedEndpoints() error {
	pkgInfo := x.iprog.Package("github.com/liyuliang/text/message")
	if pkgInfo == nil {
		return errors.New("pipeline: github.com/liyuliang/text/message is not imported")
	}
