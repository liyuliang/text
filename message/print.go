...
import (
	...
	"github.com/liyuliang/text/internal/format"
...
// It implements "github.com/liyuliang/text/internal/format".State.
type printer struct {
	Printer
...
// Language implements "github.com/liyuliang/text/internal/format".State.
