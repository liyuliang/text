...
The easiest way to install is to run `go get -u github.com/liyuliang/text`. You can
also manually git clone the repository to `$GOPATH/src/github.com/liyuliang/text`.
